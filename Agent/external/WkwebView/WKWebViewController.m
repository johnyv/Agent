...
-(void)addReferer:(NSString *)string{
    NSMutableURLRequest *webRequest = [[NSMutableURLRequest alloc]initWithURL:[NSURL URLWithString:[self.wkWebView.URL absoluteString]] cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:10];
    [webRequest setValue:string forHTTPHeaderField:@"Referer"];
